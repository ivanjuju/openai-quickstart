...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('-mt', '--model_type', type=str, required=True, choices=['GLMModel', 'OpenAIModel'], help='The type of translation model to use. Choose between "GLMModel" and "OpenAIModel".')
        ...
        self.parser.add_argument('-pt', '--parser_type', type=str, default='AHEAD', choices=['AHEAD', 'BEHIND'])
